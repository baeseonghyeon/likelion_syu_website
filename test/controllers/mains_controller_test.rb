...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference('Main.count') do
      post mains_url, params: { main: { content: @main.content, hack: @main.hack, hidden: @main.hidden, lion: @main.lion, service: @main.service, th: @main.th, title: @main.title } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { content: @main.content, hack: @main.hack, hidden: @main.hidden, lion: @main.lion, service: @main.service, th: @main.th, title: @main.title } }
